...
| <a name="input_postgres_db_name"></a> [postgres\_db\_name](#input\_postgres\_db\_name) | The name of the database to connect to | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `postgres` |
| <a name="input_postgres_db_password"></a> [postgres\_db\_password](#input\_postgres\_db\_password) | The password to use to connect to the database | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `postgres` |
| <a name="input_postgres_db_username"></a> [postgres\_db\_username](#input\_postgres\_db\_username) | The username to use to connect to the database | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `postgres` |
...
| <a name="input_snowflake_account"></a> [snowflake\_account](#input\_snowflake\_account) | Snowflake account to use | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_database"></a> [snowflake\_database](#input\_snowflake\_database) | Snowflake database name | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_loader_password"></a> [snowflake\_loader\_password](#input\_snowflake\_loader\_password) | The password to use for the loader user | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_loader_role"></a> [snowflake\_loader\_role](#input\_snowflake\_loader\_role) | Snowflake role for loading snowplow data | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_loader_user"></a> [snowflake\_loader\_user](#input\_snowflake\_loader\_user) | The Snowflake user used by Snowflake Loader | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_region"></a> [snowflake\_region](#input\_snowflake\_region) | Region of Snowflake account | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_schema"></a> [snowflake\_schema](#input\_snowflake\_schema) | Snowflake schema name | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_transformed_stage_name"></a> [snowflake\_transformed\_stage\_name](#input\_snowflake\_transformed\_stage\_name) | Name of transformed stage | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
| <a name="input_snowflake_warehouse"></a> [snowflake\_warehouse](#input\_snowflake\_warehouse) | Snowflake warehouse name | `string` | n/a | yes if [pipeline\_db](#input\_pipeline\_db) is `snowflake` |
